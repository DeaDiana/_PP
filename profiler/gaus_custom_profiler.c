...
int main(int argc, char* argv[]){
    ...
    MPI_Status status;
    int label_event_begin_1stpass;
    int label_event_end_1stpass;
    int label_event_begin_2ndpass;
    int label_event_end_2ndpass;
...
//---------------------------------------parallel computation
    ...
    label_event_begin_1stpass = MPE_Log_get_event_number();
    label_event_end_1stpass = MPE_Log_get_event_number();
    label_event_begin_2ndpass = MPE_Log_get_event_number();
    label_event_end_2ndpass = MPE_Log_get_event_number();
    MPE_Describe_state(label_event_begin_1stpass, label_event_end_1stpass, "1stpass", "red");
    MPE_Describe_state(label_event_begin_2ndpass, label_event_end_2ndpass, "2ndpass", "blue");
...
//gauss algorithm
    //1st pass																					
	//receive row
    MPE_Log_event(label_event_begin_1stpass, rank, (char*)0);
    ...
    MPE_Log_event(label_event_end_1stpass, rank, (char*)0);
    MPE_Log_event(label_event_begin_2ndpass, rank, (char*)0);
    //back pass
    ...
    MPE_Log_event(label_event_end_2ndpass, rank, (char*)0);
